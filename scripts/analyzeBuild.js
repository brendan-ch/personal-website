// https://github.com/zephraph/just-be/blob/master/scripts/trace.js
...
const DEBUG = path.join(process.cwd(), 'scripts', 'output', 'trace-debug.log');
...
;(async () => {
  ...
  let sortedFiles = Array.from(fileList)
    .map((file) => {
